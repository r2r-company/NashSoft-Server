...
def widont_html(value):
    ...
    >>> print(widont_html('<p>tests me<br /> out</p><h2>Ok?</h2>Not in a p<p title="tests me">and this</p>'))
    <p>tests&nbsp;me<br /> out</p><h2>Ok?</h2>Not in a&nbsp;p<p title="tests me">and&nbsp;this</p>

    >>> print(widont_html('leading text  <p>tests me out</p>  trailing text'))
    leading&nbsp;text  <p>tests me&nbsp;out</p>  trailing&nbsp;text
    """  # noqa: E501
