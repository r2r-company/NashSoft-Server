...
class Command(BaseCommand):
    help = "Drops tests database for this project."
    ...
    def handle(self, *args, **options):
        """Drop tests database for this project."""
        ...
        if options["interactive"]:
            confirm = input(
                """
You have requested to drop all tests databases.
This will IRREVERSIBLY DESTROY
ALL data in the database "{db_name}"
and all cloned tests databases generated via
...
Type 'yes' to continue, or 'no' to cancel: """.format(db_name=database_name)
        ...
        def get_database_names(formatter):
            """
            Return a generator of all possible tests database names.
        ...
        if engine in SQLITE_ENGINES:
            # By default all sqlite tests databases are created in memory.
            # There will only be database files to delete if the developer has
            # specified a tests database name, which forces files to be written
            # to disk.
