...
class Bind(Setting):
    ...
    desc = """\
        ...
        Multiple addresses can be bound. ex.::
            ...
            $ gunicorn -b 127.0.0.1:8000 -b [::1]:8000 tests:app

        will bind the `tests:app` application on localhost both on ipv6
        and ipv4 interfaces.
...
class Env(Setting):
    ...
    desc = """\
        ...
        .. code-block:: console
            ...
            $ gunicorn -b 127.0.0.1:8000 --env FOO=1 tests:app
