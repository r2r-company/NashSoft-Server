...
def execute_values(cur, sql, argslist, template=None, page_size=100, fetch=False):
    ...
    **not** contain a total result.
    ...
    possible to use it with other statements, for example::
        ...
        >>> cur.execute(
        ... "create table tests (id int primary key, v1 int, v2 int)")

        >>> execute_values(cur,
        ... "INSERT INTO tests (id, v1, v2) VALUES %s",
        ... [(1, 2, 3), (4, 5, 6), (7, 8, 9)])

        >>> execute_values(cur,
        ... """UPDATE tests SET v1 = data.v1 FROM (VALUES %s) AS data (id, v1)
        ... WHERE tests.id = data.id""",
        ... [(1, 20), (4, 50)])
